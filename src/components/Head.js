  ...
  return (
    <div className="grid grid-flow-col p-6">
      ...
      <div className="col-span-1 flex gap-10 justify-center">
        ...
        <img alt="profile" src="https://media.licdn.com/dms/image/D5603AQHrPTKpxUfLPg/profile-displayphoto-shrink_800_800/0/1672628313482?e=2147483647&v=beta&t=KBrdVzNka8GSX3MRSc4br2Lc-Zwc2xnGzx-KQ65b6o8" className=" h-10 rounded-full" />
      </div>
    </div>
  );
};
